#ifndef ALGEBRA_LAPACK_HPP_
#define ALGEBRA_LAPACK_HPP_
...
void sgesv_(const int *, const int *, float *, const int *, int *,
            float *, const int *, int *);
// Double Precision
...
template <> struct lapack<float> {
  ...
  static int gesv(const int n, const int nrhs, float *a, const int lda, int *ipiv,
                   float *b, const int ldb) {
    int info;
...
template <> struct lapack<double> {
  ...
  static int gesv(const int n, const int nrhs, double* a, const int lda, int *ipiv,
                   double *b, const int ldb) {
      int info;
      dgesv_(&n, &nrhs, a, &lda, ipiv, b, &ldb, &info);
      return info;
  }
  // static int dlange(const char norm, const int m, const int n, double *a, 
